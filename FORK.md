...
| `agent/webhooks/linear.py` | Best-effort trace-comment failure containment after run dispatch (OPE-158) | The run dispatch is the durable delivery commit point; trailing observability failure must not release the comment claim and launch a duplicate run. |
